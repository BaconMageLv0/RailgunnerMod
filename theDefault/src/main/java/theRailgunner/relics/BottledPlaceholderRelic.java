...
import theRailgunner.patches.relics.BottledPlaceholderField;
import theRailgunner.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theRailgunner.DefaultMod.makeRelicOutlinePath;
import static theRailgunner.DefaultMod.makeRelicPath;
